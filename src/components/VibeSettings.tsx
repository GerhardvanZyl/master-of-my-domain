...
const FIELDS: {
  ...
  { key: "priceAboveExponent", label: "…^this (1 = linear)", sign: "", step: 0.1 },
  { key: "perBelow10000", label: "per $10k below ideal", sign: "−" },
  { key: "priceBelowExponent", label: "…^this (1 = linear)", sign: "", step: 0.1 },
  ...
  { key: "flindersExponent", label: "…^this (1 = linear)", sign: "", step: 0.1 },
  { key: "noEaves", label: "no all-around eaves", sign: "−" },
  { key: "noPergola", label: "no covered pergola/deck", sign: "−" },
  { key: "noLawn", label: "no lawn", sign: "−" },
  { key: "perLivingArea", label: "per living area", sign: "+" },
  { key: "perBedBelow4", label: "per bedroom under 4", sign: "−" },
  { key: "perMasterSqmBelow18", label: "per m² master under 18", sign: "−" },
  { key: "perOtherBedSqmBelow11", label: "per m² other beds under 11", sign: "−" },
